    ...
    return(
     ...
     <div className="contacts">
      ...
      <div className="socials">
       <Link href="https://www.facebook.com/?locale=uk_UA"><Image src="/img" alt="Facebook" width={30} height={30} /></Link>
       <Link href="https://www.instagram.com/"><Image src="/img" alt="Instagram" width={30} height={30} /></Link>
      </div>
    </div>
        </div>
    )
